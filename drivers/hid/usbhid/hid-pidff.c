...
static int pidff_init_fields(struct pidff_device *pidff, struct input_dev *dev)
{
	...
	dbg_hid("Searching for SetEffect fields");
...
//		return -ENODEV;
	...
	dbg_hid("Searching for BlockLoad fields");
...
//		return -ENODEV;
	...
	dbg_hid("Searching for EffectOperation fields");
...
//		return -ENODEV;
	...
	dbg_hid("Searching for BlockFree fields");
...
//		return -ENODEV;
	...
	dbg_hid("Searching for SetEnvelope fields");
...
//		return -ENODEV;
	...
	{
	    dbg_hid("Searching for SetConstant fields");
	...
	if (test_bit(FF_RAMP, dev->ffbit)) {
	    dbg_hid("Searching for SetRamp fields");
	...
	if ((test_bit(FF_SPRING, dev->ffbit) ||
	    ...
	    dbg_hid("Searching for SetCondition fields");
	...
	if (test_bit(FF_PERIODIC, dev->ffbit)) {
	    dbg_hid("Searching for SetPeriodic fields");
	...
	dbg_hid("Searching for Pool fields");
	PIDFF_FIND_FIELDS(pool, PID_POOL, 0);

	dbg_hid("Searching for DeviceGain fields");
